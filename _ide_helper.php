...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Baloot\BalootServiceProvider::registerQueryBuilderMacros()
         * @param string $column
         ...
         * @static 
         */ 
        public static function whereJalali($column, $operator, $value = null, $boolean = 'and')
        {
                        return \Illuminate\Database\Query\Builder::whereJalali($column, $operator, $value, $boolean);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function whereDateJalali($column, $operator, $value = null, $boolean = 'and')
        {
                        return \Illuminate\Database\Query\Builder::whereDateJalali($column, $operator, $value, $boolean);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function whereInMonthJalali($column, $month, $year = null)
        {
                        return \Illuminate\Database\Query\Builder::whereInMonthJalali($column, $month, $year);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function whereInYearJalali($column, $year = null)
        {
                        return \Illuminate\Database\Query\Builder::whereInYearJalali($column, $year);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function whereBetweenJalali($column, $values, $boolean = 'and', $not = false)
        {
                        return \Illuminate\Database\Query\Builder::whereBetweenJalali($column, $values, $boolean, $not);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function whereNotBetweenJalali($column, $values, $boolean = 'and', $not = false)
        {
                        return \Illuminate\Database\Query\Builder::whereNotBetweenJalali($column, $values, $boolean, $not);
        }
