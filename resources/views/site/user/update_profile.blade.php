                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" value="{{Auth::user()->phone}}" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-sm-6 form-group">
                            <label class="text-danger">شماره شبا</label>
                            <input type="text" name="sheba" value="{{Auth::user()->sheba}}" class="form-control">
                        </div>
                        <div class="col-sm-6 col-md-4 form-group">
                            ...
                            <select id="category_id" name="category_id" class="form-control">
                                ...
                                @foreach(\App\Models\Category::all() as $category)
                                    <option {{ ( Auth::user()->category != null && $category->id === Auth::user()->category->id) ? 'selected' : '' }} value="{{$category->id}}">{{$category->name}}</option>
                                @endforeach
